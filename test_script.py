...
response = requests.get("https://raw.githubusercontent.com/thewhitesoft/student-2023-assignment/main/data.json")
data_json = json.loads(response.text)

text_data=data_json
# Получение данных с файла
# with open('C:/Users/APTYP/Desktop/data.json') as json_file:
#     text_data = json.load(json_file)

with open('C:/Users/APTYP/Desktop/replacement.json') as json_file: # прописать сой путь к файлу "replacement.json"
...
for printt in list_edited_text:
    print(printt)
    file = open('C:/Users/APTYP/Desktop/result.json', 'w')# прописать свой путь для сохранения файла
